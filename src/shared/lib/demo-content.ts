...
export const overviewPageCopy = {
  description:
    '【占位文本】本课题页用于展示暨南大学相关课题组基于《全粤村情》资料开展的阶段性整理与研究方向。当前内容以占位说明为主，后续可替换为正式课题简介。课题组主要围绕广东省自然村的方言分布、村落文化、地方民俗、历史源流与地名线索等内容展开持续研究，希望通过地图检索、专题浏览与村庄详情联动的方式，把分散的村落资料整理成更便于阅读、比对与观察的数字化入口，也为后续扩充更完整的专题成果、田野材料与研究说明预留结构。',
  eyebrow: '课题导览',
  title: '课题简介',
};
